...
<body>
    ...
    <div class="nav-drawer" id="navDrawer">
        ...
        <div class="nav-drawer-menu" id="navDrawerMenu">
            <a href="{{ route('home') }}" class="nav-drawer-link {{ request()->routeIs('home') ? 'active' : '' }}">Beranda</a>
            <a href="{{ route('menu') }}" class="nav-drawer-link {{ request()->routeIs('menu') ? 'active' : '' }}">Menu</a>
            <a href="{{ route('gallery') }}" class="nav-drawer-link {{ request()->routeIs('gallery*') ? 'active' : '' }}">Gallery</a>
            <a href="{{ route('about') }}" class="nav-drawer-link {{ request()->routeIs('about') ? 'active' : '' }}">Tentang Kami</a>
            <a href="{{ route('contact') }}" class="nav-drawer-link {{ request()->routeIs('contact') ? 'active' : '' }}">Kontak</a>
            <div class="nav-drawer-divider"></div>
            <a href="https://wa.me/{{ $siteSettings['whatsapp'] }}?text=Halo%20Warkop%20KPK!" class="nav-drawer-link" target="_blank">Hubungi WhatsApp</a>
            <a href="{{ route('login') }}" class="nav-drawer-link">Masuk Admin</a>
        </div>
        <div class="nav-drawer-footer">
            <p>Jam Buka: {{ $siteSettings['jam_buka'] }}</p>
        </div>
    </div>
    ...
    <a href="https://wa.me/{{ $siteSettings['whatsapp'] }}?text=Halo%20Warkop%20KPK!%20Saya%20ingin%20bertanya..." class="whatsapp-float" target="_blank" aria-label="Chat via WhatsApp">
