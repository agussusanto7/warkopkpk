...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-container">
            ...
            <button class="nav-toggle" id="navToggle" aria-label="Buka menu navigasi" aria-expanded="false" style="cursor:pointer;touch-action:manipulation;-webkit-tap-highlight-color:transparent">
                <div class="hamburger" style="pointer-events:none">
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
    ...
    <div class="nav-drawer" id="navDrawer" aria-hidden="true">
        ...
        <nav class="nav-drawer-menu" id="navDrawerMenu">
            <a href="{{ route('home') }}" class="nav-drawer-link {{ request()->routeIs('home') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                Beranda
            </a>
            <a href="{{ route('menu') }}" class="nav-drawer-link {{ request()->routeIs('menu') ? 'active' : '' }}">
            ...
            <a href="{{ route('gallery') }}" class="nav-drawer-link {{ request()->routeIs('gallery*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                Gallery
            </a>
            <a href="{{ route('about') }}" class="nav-drawer-link {{ request()->routeIs('about') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                Tentang Kami
            </a>
            <a href="{{ route('contact') }}" class="nav-drawer-link {{ request()->routeIs('contact') ? 'active' : '' }}">
            ...
            <a href="https://wa.me/{{ $siteSettings['whatsapp'] }}?text=Halo%20Warkop%20KPK!" class="nav-drawer-link" target="_blank">
            ...
            <a href="{{ route('login') }}" class="nav-drawer-link">
        ...
        <div class="nav-drawer-footer">
            <div style="text-align:center">
                <p style="font-size:.7rem;color:rgba(255,255,255,.35);margin-bottom:5px;text-transform:uppercase;letter-spacing:1.5px;font-weight:600">Jam Operasional</p>
                <p style="font-size:.88rem;color:rgba(255,255,255,.75);font-weight:500;line-height:1.6">{!! nl2br(e($siteSettings['jam_buka'])) !!}</p>
            </div>
        </div>
    </div>
        ...
        <div class="footer-container container">
            <div class="footer-grid">
                <div class="footer-col footer-about">
                    ...
                    <p>Tempat terbaik untuk menikmati secangkir kopi berkualitas dengan suasana yang nyaman dan hangat.</p>
                    <div class="footer-socials">
                        ...
                        <a href="#" class="social-link" aria-label="TikTok">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12a4 4 0 104 4V4a5 5 0 005 5"/></svg>
                        </a>
                    </div>
                </div>
